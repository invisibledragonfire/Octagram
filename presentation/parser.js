function parseSpell(spell) {
  ...
  resultElement.attributeStyleMap.set("background-image", "none");
  resultElement.classList.remove("element");

  if (result === RUNE.FIRE) {
    resultElement.attributeStyleMap.set("background-image", 'url("fire.svg")');
    resultElement.classList.add("element");
    resultElement.innerText = "";
    return;
  }
  if (result === RUNE.WATER) {
    resultElement.attributeStyleMap.set("background-image", 'url("water.svg")');
    resultElement.classList.add("element");
    resultElement.innerText = "";
    return;
  }
